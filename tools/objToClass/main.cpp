...
int main(){
    ...
    cout << "};" << endl << "};";
	myfile.close();
    myfile.open(filename+"_normals.hpp");
    myfile << "#include <iostream>" << endl << endl;
    myfile << "class " << filename << "_normals {" << endl;
    myfile << "public:" << endl;
    myfile << "float normals [16383] = {" << endl;
    cout << "#include <iostream>;" << endl << endl;
    cout << "class " << filename << "_normals {" << endl;
    ...
    cout << "};" << endl << "};";
	myfile.close();
    myfile.open(filename+"_uv.hpp");
    myfile << "#include <iostream>" << endl << endl;
    myfile << "class " << filename << "_uv {" << endl;
    myfile << "public:" << endl;
    myfile << "float uv [16383] = {" << endl;
    cout << "#include <iostream>;" << endl << endl;
    cout << "class " << filename << "_uv {" << endl;
